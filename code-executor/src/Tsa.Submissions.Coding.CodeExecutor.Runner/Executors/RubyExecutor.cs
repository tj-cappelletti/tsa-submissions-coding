...
/// </summary>
public class RubyExecutor : ILanguageExecutor
{
    /// <inheritdoc/>
    public Task PrepareAsync(ExecutionContext context, CancellationToken cancellationToken = default)
    {
        // Ruby is interpreted, just save the source code to a file
        var scriptPath = Path.Combine(context.WorkingDirectory, "solution.rb");
